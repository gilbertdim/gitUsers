        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('git.users')" :active="request()->routeIs('git.users')">
                        {{ __('Git User') }}
                    </x-nav-link>
                    <x-nav-link :href="route('challenge.hamming.distance')" :active="request()->routeIs('challenge.hamming.distance')">
                        {{ __('Hamming Distance') }}
                    </x-nav-link>
                </div>
            </div>
